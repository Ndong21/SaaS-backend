...
func run() error {
	...
	err = repo.MigrateUp(dbConnectionURL, config.MigrationsPath)
	if err != nil {
	...
	handler := api.NewStockHandler(querier).WireHttpHandler()
...
func LoadConfig(cfg *Config) error {
	...
	//parse the contain of the env file into the config struct
